 ...
 *
 * @version one.java
 * @version Created on 25 Jul, 2015, 3:06:13 PM
 * @author RAVI
 */

public class one extends AbstractPageBean {
    ...
    private void _init() throws Exception {
        user_infoDataProvider.setCachedRowSet((javax.sql.rowset.CachedRowSet) getValue("#{one.user_infoRowSet}"));
        user_infoRowSet.setDataSourceName("java:comp/env/jdbc/SAM_ApacheDerby");
        user_infoRowSet.setCommand("SELECT * FROM SAM.USER_INFO");
    ...
    public void init() {
        ...
        try {
            ...
            log("one Initialization Failure", e);
